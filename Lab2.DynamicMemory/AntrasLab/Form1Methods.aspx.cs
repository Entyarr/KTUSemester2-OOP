...
namespace AntrasLab
{
    ...
    {
        public void CustomersTable(Table table, CustomerList customers)
        {
            table.Rows.Clear();
        ...
        public void AgentsTable(Table table, AgentList agents)
        {
            table.Rows.Clear();
        ...
        public void MonthTable(Table table, CustomersByAgentList agents)
        {
            table.Rows.Clear();
